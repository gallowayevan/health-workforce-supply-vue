...
export default {
  ...
  computed: {
    barChartHeader(){
        const currRegion = this.aggregationLevel == "county" && this.region != "North Carolina" ? `${this.region} County` : this.aggregationLevel == "ahec" && this.region.indexOf("AHEC") == -1 && this.region != "North Carolina" ? `${this.region} AHEC` : this.region; 
